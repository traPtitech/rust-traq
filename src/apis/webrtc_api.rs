...
pub async fn get_web_rtc_state(
    ...
    let local_var_uri_str = format!("{}/webrtc/state", local_var_configuration.base_path);
...
pub async fn post_web_rtc_authenticate(
    ...
    let local_var_uri_str = format!("{}/webrtc/authenticate", local_var_configuration.base_path);
    let mut local_var_req_builder =
