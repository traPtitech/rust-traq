...
pub async fn change_my_notify_citation(
    configuration: &configuration::Configuration,
    put_notify_citation_request: Option<crate::models::PutNotifyCitationRequest>,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChangeMyNotifyCitationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_my_notify_citation(
    configuration: &configuration::Configuration,
) -> Result<crate::models::GetNotifyCitation, Error<GetMyNotifyCitationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMyNotifyCitationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_my_stamp_recommendations(
    configuration: &configuration::Configuration,
    limit: Option<i32>,
) -> Result<Vec<uuid::Uuid>, Error<GetMyStampRecommendationsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_settings(
    configuration: &configuration::Configuration,
) -> Result<crate::models::UserSettings, Error<GetUserSettingsError>> {
    let local_var_configuration = configuration;
